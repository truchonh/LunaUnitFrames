				...
				topleft = {
					...
					args = {
						...
						type = {
							...
							type = "select",
							order = 3,
							values = { ["aggro"] = L["Aggro"], ["legacythreat"] = L["Aggro"].." ("..L["targettarget"]..")", ["aura"] = L["Buff/Debuff"], ["ownaura"] = L["Own buff/debuff"], ["dispel"] = DISPELS, ["missing"] = L["Missing Buff"], ["minduration"] = "Shortest duration" },
					...
					GeneralOptions = {
						...
						args = {
							...
							headerraid9 = {
								...
								type = "header",
								order = 2.49,
								hidden = function() return LUF.db.profile.units.raid.groupBy ~= "CLASS" end,
							},
							enabled9 = {
								name = ENABLE,
								desc = L["Enable this group"],
			...
			autoprofiles = {
				...
				args = {
					...
					groupselect = {
						...
						values = {["RAID40"]=L["Raid40"],["RAID30"]=L["Raid30"],["RAID20"]=L["Raid20"],["RAID10"]=L["Raid10"],["RAID5"]=L["Raid5"],["PARTY"]=PARTY,["SOLO"]=L["Solo"],},
					...
					profileselect = {
						...
						set = function(info, value)
							...
							elseif LUF.db.char.switchtype == "GROUP" then
								...
								LUF.db.char.grpdb["ARENA"] = value ~= "NIL" and profiledb[value] or nil
							end
						end,
					},
				},
